...
The device token returned by Xiaomi is stored in the Keychain on your phone. You can erase it at any time with a long press on the RESET button in the application.

Scales other than Hoto do not require any account.
